...
namespace Supermarket.Tests
{
    public class CheckoutTests
    {
        ...
        public void ShouldCheckoutSingleItemInBasket()
        {
            ...
            skus.AddOrUpdate(new Sku { ItemName = "B", Price = 3, Offers = new[] { new Pricing { Units = 3, OfferPrice = 4.5m } } });
        ...
        public void ShouldThrowIfSkuNotFound()
        {
            var skus = new Skus();
            var basket = new List<(Sku sku, int items)>();
            basket.Add((new Sku { ItemName = "A", Price = 5, Offers = new[] { new Pricing { Units = 3, OfferPrice = 13 } } }, 1));
