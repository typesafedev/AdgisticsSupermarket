...
namespace Supermarket.Tests
{
    public class KartTests
    {
        ...
        {
            var stock = new Skus();
            stock.AddOrUpdate(new Sku { ItemName = "A", Price = 5, Offers = new[] { new Pricing { Units = 3, OfferPrice = 13 } } });
            stock.AddOrUpdate(new Sku { ItemName = "B", Price = 3, Offers = new[] { new Pricing { Units = 2, OfferPrice = 4.5m } } });
            var sut = new Kart();
